# Curated tournament with 8 matches/pair (2x data, same teachers).
# Tests whether the curated 41.9% gain saturates or scales with sample size.

$ErrorActionPreference = 'Continue'
Set-Location J:\antcolony

$run_dir   = "J:\antcolony\bench\curated-2x"
$traj      = Join-Path $run_dir "trajectories.jsonl"
$filtered  = Join-Path $run_dir "trajectories_filtered.jsonl"
$weights   = Join-Path $run_dir "mlp_weights_2x.json"
$bench_exe = "J:\antcolony\target\release\examples\matchup_bench.exe"
$matches_per_pair = 8   # 12*11*8 = 1056 matches
$max_ticks = 10000
...
Log "=== Curated-2x: $($brains.Count) brains, $matches_per_pair matches/pair ==="
...
Log "=== Train MLP on 2x curated corpus ==="
